...
import SvelteTable from './Table.svelte';
...
<form on:submit|preventDefault>
  <SvelteInput label="Company:" bind:value={entry.company} />
  <SvelteInput label="Status:" bind:value={entry.status} />
  <SvelteInput label="Description:" bind:value={entry.about} />
  <SvelteButton on:click={validate} disabled={!entry.company || !entry.status || !entry.about}>Save</SvelteButton>
</form> 
{/if}
